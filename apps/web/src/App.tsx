...
const pricingPlans: PricingPlan[] = [
  {
    ...
    limits: [
      "6 créditos de conteúdo por mês",
      "Equivale a até 6 posts estáticos",
      "1 marca e 1 canal",
      "Até 2 carrosséis por mês",
      "1 ciclo de revisão por conteúdo",
  ...
  },
  {
    ...
    limits: [
      "15 créditos de conteúdo por mês",
      "Equivale a até 15 posts estáticos",
      "1 marca e até 2 canais",
      "Até 5 carrosséis por mês",
      "Até 2 roteiros de vídeo curto",
      "2 ciclos de revisão por conteúdo",
      "Calendário, aprovação e agendamento",
    ],
  ...
  },
  {
    ...
    limits: [
      "30 créditos de conteúdo por mês",
      "Equivale a até 30 posts estáticos",
      "Até 2 marcas e 4 canais",
      "Até 10 carrosséis por mês",
      "Até 6 roteiros de vídeo curto",
      "3 ciclos de revisão por conteúdo",
      "Campanhas, agendamento e insights",
    ],
  ...
  },
  {
    ...
    limits: [
      "60 créditos de conteúdo por mês",
      "Equivale a até 60 posts estáticos",
      "Até 4 marcas e 8 canais",
      "Até 12 carrosséis por mês",
      "Até 12 roteiros de vídeo curto",
      "Até 8 usuários",
      "Fluxos de aprovação e relatórios",
    ],
        ...
        <section className="hero container">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <a className="button button-primary" href="#diagnostico">Analisar minha marca <span>↗</span></a>
        ...
        <section className="pricing-section" id="plano">
          <div className="container">
            <div className="pricing-heading">
              <div className="section-kicker">PLANOS MODO</div>
              <h2>Capacidade clara para cada <strong>ritmo de presença.</strong></h2>
              <p>Você sabe exatamente quantos conteúdos, marcas, canais e revisões estão incluídos. Sem promessa ilimitada escondendo custo ou perda de qualidade.</p>
            </div>

            <div className="pricing-grid">
              {pricingPlans.map((plan) => (
                <article className={plan.featured ? "pricing-card featured" : "pricing-card"} key={plan.slug}>
                  {plan.featured && <div className="pricing-badge">MAIS ESCOLHIDO</div>}
                  ...
                  <div className="pricing-price">
                    ...
                    <div><span>R$</span><strong>{plan.price}</strong><b>/mês</b></div>
                  </div>
                  <p className="pricing-description">{plan.description}</p>
                  <ul className="pricing-limits">
                    {plan.limits.map((limit) => <li key={limit}>{limit}</li>)}
                  </ul>
                  <button className={plan.featured ? "button button-primary button-full" : "button button-outline button-full"} onClick={() => activatePlan(plan.slug)}>{plan.cta} ↗</button>
                </article>
              ))}
            </div>
            ...
            <div className="credit-rules">
              <div>
                <strong>Como os créditos funcionam</strong>
                <p>Post estático ou story: 1 crédito. Carrossel de até 7 páginas: 2 créditos. Roteiro de vídeo curto: 2 créditos.</p>
              </div>
              <div>
                <strong>Canais e adaptações</strong>
                <p>Publicar a mesma peça em outro canal não consome crédito extra. Uma adaptação específica de formato ou texto consome 1 crédito.</p>
              </div>
              <div>
                <strong>Revisões e excedentes</strong>
                <p>Revisões além do limite e capacidade adicional serão contratadas por pacotes, sem transformar o plano em uso ilimitado.</p>
              </div>
            </div>
          </div>
        </section>
